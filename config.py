...
__C.CONST.NUM_WORKER                    = 2                       # number of data workers
...
if cfg.DATASET.DATASET_NAME == 'VideoDeblur':
    __C.DIR.DATASET_JSON_FILE_PATH = './datasets/VideoDeblur_300VW.json'
    __C.DIR.DATASET_ROOT = './datasets/300VW_STFAN_P'
    __C.DIR.LANDMARK_INFO = './datasets/300VW_STFAN_P/landmarks_clean.pkl'
...
### Additional
__C.DATA.SIGMA                          = 5                       # heatmap sigma
__C.DATA.SIZE                           = (256, 256)              # H, W
